...
export default function LoginForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="mx-auto flex flex-col p-10 w-full max-w-xl text-left font-sans">
            ...
            ></input>
                <button type="submit" disabled={loading} className="bg-black text-white hover:cursor-pointer p-3 rounded-4xl disabled:bg-gray-500 disabled:cursor-not-allowed">{(loading) ? "Signing In..." : "Sign In"}</button>
        </form>
    )
}